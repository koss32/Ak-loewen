...
- Локально проверенный кандидат: `f5c3660407a6bae1d66d5c3ea662fe5c119c5ea4`.
- `release-5` — неизменяемый baseline `c52e77dcde8548e00f2e6208b143dc87c37f811e`.
- Push ещё не считается выполненным этим документом. После push родитель должен записать фактический remote SHA в `DELIVERY.json`; synthetic или локальный SHA за remote не выдавать.
