 ...
 * 3 AK Löwen × VALSET union composition
...
export function applyRelease4(html,locale='de'){
 ...
 html=html.replace('<div class="contact-card"><h3>AK Löwen</h3>','<div class="contact-card"><div class="contact-head"><img class="contact-logo" src="/assets/ak-logo.png" alt="AK Löwen" width="54" height="54" loading="lazy"><h3>AK Löwen</h3></div>');
 html=html.replace('<div id="valset-kontakt" class="contact-card b"><h3>VALSET</h3>','<div id="valset-kontakt" class="contact-card b"><div class="contact-head"><img class="contact-logo" src="/assets/valset-logo.svg" alt="VALSET" width="54" height="54" loading="lazy"><h3>VALSET</h3></div>');
